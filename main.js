    ...
    fetch(url)
        ...
        .then(data => {
            ...
            <figure>
                ...
                <figurecaption>${weather[0]["description"]}</figurecaption> //description: broken clothes
            </figure>
            `;
            li.innerHTML = markup;
            list.appendChild(li); //harbar ke ye shahr mizanim, be liste shahr haye ghabli ezafe mikone va dar list neshun mide
            msg.innerText = ""
        })
        .catch(() => {
